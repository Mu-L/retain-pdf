...
- `gs`
  refs: `retainpdf_pipeline/services/rendering/source/compression/ghostscript.py`

## Package Map

| Import | Package | Runtime | Test | Example refs |
| --- | --- | --- | --- | --- |
| `PIL` | `Pillow` | yes | yes | `retainpdf_pipeline/services/rendering/layout/inline_content/fallback/png_renderer.py`, `retainpdf_pipeline/services/rendering/source/background/extract.py`, `retainpdf_pipeline/services/rendering/source/background/patch.py` |
...
| `fitz` | `PyMuPDF` | yes | yes | `retainpdf_pipeline/runtime/pipeline/render_mode.py`, `retainpdf_pipeline/services/document_operations/visual_validation.py`, `retainpdf_pipeline/services/ocr_provider/paddle_normalize.py` |
...
| `pikepdf` | `pikepdf` | yes | yes | `retainpdf_pipeline/services/document_operations/page_program.py`, `retainpdf_pipeline/services/rendering/document/pikepdf_overlay.py`, `retainpdf_pipeline/services/rendering/document/pikepdf_pages.py` |
...
| `requests` | `requests` | yes | yes | `retainpdf_pipeline/services/mineru/mineru_api.py`, `retainpdf_pipeline/services/network/retry.py`, `retainpdf_pipeline/services/ocr_provider/paddle_api.py` |
| `urllib3` | `urllib3` | yes | no | `retainpdf_pipeline/services/network/retry.py`, `retainpdf_pipeline/services/translation/llm/providers/deepseek/transport.py` |
