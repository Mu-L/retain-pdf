...
| `fitz` | `PyMuPDF` | yes | yes | `retainpdf_pipeline/runtime/pipeline/render_mode.py`, `retainpdf_pipeline/document_operations/visual_validation.py`, `retainpdf_pipeline/ocr/ocr_provider/paddle_normalize.py` |
