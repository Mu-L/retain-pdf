...
- API 摘要：
  [`API_SUMMARY.md`](services/api/src/ocr_provider/paddle/API_SUMMARY.md)
- 官方异步接口示例：
  [`AsyncParse.md`](services/api/src/ocr_provider/paddle/AsyncParse.md)

## 1. Paddle Provider API 的三段式边界

根据 [AsyncParse.md](services/api/src/ocr_provider/paddle/AsyncParse.md)，Paddle 的异步接口天然分成三段：
