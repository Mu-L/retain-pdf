...
ENTRYPOINT_IMPORT_ALLOWLIST: dict[Path, tuple[str, ...]] = {
    ...
    Path("translate_book.py"): ("from retainpdf_pipeline.translate.entrypoints.translate_only_pipeline import main",),
    Path("translate_page.py"): (
        "from retainpdf_pipeline.translate.public import",
    ),
    Path("validate_document_schema.py"): ("from retainpdf_pipeline.ocr.document_schema import",),
}
