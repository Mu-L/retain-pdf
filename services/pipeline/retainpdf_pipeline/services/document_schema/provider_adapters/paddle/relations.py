...
from retainpdf_pipeline.services.document_schema.provider_adapters.common import classify_with_previous_anchor
from retainpdf_pipeline.services.document_schema.provider_adapters.paddle.block_labels import map_block_kind
