...
def _build_mineru_document(payload: dict, document_id: str, source_json_path: Path, provider_version: str) -> dict:
    from retainpdf_pipeline.services.document_schema.provider_adapters.mineru import build_mineru_document
...
def _build_mineru_content_list_v2_document(payload: dict, document_id: str, source_json_path: Path, provider_version: str) -> dict:
    from retainpdf_pipeline.services.document_schema.provider_adapters.mineru_content_list_v2_adapter import (
...
def _build_generic_flat_ocr_document(payload: dict, document_id: str, source_json_path: Path, provider_version: str) -> dict:
    from retainpdf_pipeline.services.document_schema.provider_adapters.generic_flat_ocr_adapter import (
...
def _build_paddle_document(payload: dict, document_id: str, source_json_path: Path, provider_version: str) -> dict:
    from retainpdf_pipeline.services.document_schema.provider_adapters.paddle import (
...
def _looks_like_mineru_layout(payload: dict) -> bool:
    from retainpdf_pipeline.services.document_schema.provider_adapters.mineru import looks_like_mineru_layout
