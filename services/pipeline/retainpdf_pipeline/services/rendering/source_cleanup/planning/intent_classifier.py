...
from retainpdf_pipeline.services.rendering.source_cleanup.intents import CLEANUP_ACTION_NOOP
from retainpdf_pipeline.services.rendering.source_cleanup.intents import CLEANUP_ACTION_PROTECT_SOURCE
from retainpdf_pipeline.services.rendering.source_cleanup.intents import CLEANUP_ACTION_STRIP_TEXT
from retainpdf_pipeline.services.rendering.source_cleanup.intents import REPLACEMENT_KIND_NONE
from retainpdf_pipeline.services.rendering.source_cleanup.intents import REPLACEMENT_KIND_PRESERVE_SOURCE
from retainpdf_pipeline.services.rendering.source_cleanup.intents import REPLACEMENT_KIND_TEXT_OVERLAY
from retainpdf_pipeline.services.rendering.source_cleanup.intents import SOURCE_ROLE_BODY_TEXT
from retainpdf_pipeline.services.rendering.source_cleanup.intents import SOURCE_ROLE_MATH_FORMULA
from retainpdf_pipeline.services.rendering.source_cleanup.intents import SOURCE_ROLE_MIXED_MATH_TEXT
from retainpdf_pipeline.services.rendering.source_cleanup.intents import SOURCE_ROLE_TEXTUAL_FORMULA
from retainpdf_pipeline.services.rendering.source_cleanup.intents import SOURCE_ROLE_UNKNOWN
from retainpdf_pipeline.services.rendering.source_cleanup.intents import TRANSLATION_STATE_KEPT_ORIGIN
from retainpdf_pipeline.services.rendering.source_cleanup.intents import TRANSLATION_STATE_MISSING
from retainpdf_pipeline.services.rendering.source_cleanup.intents import TRANSLATION_STATE_TRANSLATED
from retainpdf_pipeline.services.rendering.source_cleanup.intents import TRANSLATION_STATE_UNKNOWN
from retainpdf_pipeline.services.rendering.source_cleanup.intents import SourceCleanupEvidence
from retainpdf_pipeline.services.rendering.source_cleanup.intents import SourceCleanupIntent
from retainpdf_pipeline.services.rendering.source_cleanup.planning.formula_classifier import formula_text_has_latin_words
...
def classify_source_cleanup_intent(item: dict) -> SourceCleanupIntent:
    from retainpdf_pipeline.services.rendering.source_cleanup.planning.evidence import build_source_cleanup_evidence
