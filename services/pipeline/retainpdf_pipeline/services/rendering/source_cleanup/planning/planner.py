...
from retainpdf_pipeline.services.rendering.source_cleanup.planning.accumulator import BBoxTextStripCandidateAccumulator
from retainpdf_pipeline.services.rendering.source_cleanup.planning.geometry import formula_guard_rects
from retainpdf_pipeline.services.rendering.source_cleanup.planning.geometry import ocr_bbox_to_pdf_rect
from retainpdf_pipeline.services.rendering.source_cleanup.planning.item_classifier import item_allows_item_cover_fallback
from retainpdf_pipeline.services.rendering.source_cleanup.planning.items import build_source_item_rects
from retainpdf_pipeline.services.rendering.source_cleanup.planning.items import iter_formula_item_rects_for_page
from retainpdf_pipeline.services.rendering.source_cleanup.planning.items import iter_strip_item_rect_pairs_for_page
from retainpdf_pipeline.services.rendering.source_cleanup.planning.items import iter_strip_item_rects_for_page
from retainpdf_pipeline.services.rendering.source_cleanup.planning.items import item_should_emit_strip_rect
from retainpdf_pipeline.services.rendering.source_cleanup.planning.page_gate import bbox_text_strip_items_skip_reason
from retainpdf_pipeline.services.rendering.source_cleanup.planning.rect_filter import rect_overlaps_any_unsafe_vector
from retainpdf_pipeline.services.rendering.source_cleanup.planning.rects import merge_rects
from retainpdf_pipeline.services.rendering.source_cleanup.planning.coordinate_resolver import PageBBoxResolver
from retainpdf_pipeline.services.rendering.source_cleanup.planning.page_probe import page_has_form_xobjects
from retainpdf_pipeline.services.rendering.source_cleanup.planning.page_probe import page_content_stream_too_large
from retainpdf_pipeline.services.rendering.source_cleanup.planning.page_features import PageCleanupFeatures
from retainpdf_pipeline.services.rendering.source_cleanup.planning.page_features import build_page_cleanup_features
from retainpdf_pipeline.services.rendering.source_cleanup.pdf.constants import BBOX_TEXT_STRIP_CONTENT_STREAM_SIZE_THRESHOLD
from retainpdf_pipeline.services.rendering.source_cleanup.types import BBOX_TEXT_STRIP_PAGE_SKIP_NONE
from retainpdf_pipeline.services.rendering.source_cleanup.types import BBOX_TEXT_STRIP_PAGE_SKIP_COMPLEX
from retainpdf_pipeline.services.rendering.source_cleanup.types import BBOX_TEXT_STRIP_PAGE_SKIP_NO_TEXT_OVERLAP
from retainpdf_pipeline.services.rendering.source_cleanup.types import BBOX_TEXT_STRIP_PAGE_SKIP_VISUAL_BACKGROUND
from retainpdf_pipeline.services.rendering.source_cleanup.types import BBoxTextStripCandidates
from retainpdf_pipeline.services.rendering.source_cleanup.types import BBoxTextStripPagePlan
from retainpdf_pipeline.services.rendering.source_cleanup.planning.segments import strip_segments_for_text_rect
