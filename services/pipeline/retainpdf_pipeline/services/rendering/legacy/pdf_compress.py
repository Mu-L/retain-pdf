...
from retainpdf_pipeline.services.rendering.source.compression.analysis import source_pdf_has_vector_graphics
...
from retainpdf_pipeline.services.rendering.source.compression.pdf_copy import compress_pdf_images_only
