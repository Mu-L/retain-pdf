...
from retainpdf_pipeline.services.rendering.layout.text_analysis import normalize_direct_typst_math_boundaries
from retainpdf_pipeline.services.rendering.layout.text_analysis import RAW_MATH_TOKEN_KINDS
from retainpdf_pipeline.services.rendering.layout.text_analysis import replace_non_formula_segments
from retainpdf_pipeline.services.rendering.layout.text_analysis import TextToken
from retainpdf_pipeline.services.rendering.layout.text_analysis import TextTokenKind
...
def sanitize_direct_typst_inline_math(text: str) -> str:
    from retainpdf_pipeline.services.rendering.layout.inline_content.fallback.latex_normalizer import (
