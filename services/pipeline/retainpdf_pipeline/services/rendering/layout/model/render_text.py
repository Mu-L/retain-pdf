...
def _protected_map_from_formula_map(formula_map: list[dict]) -> list[dict]:
    from retainpdf_pipeline.services.rendering.layout.protected_tokens import protected_map_from_formula_map

    return protected_map_from_formula_map(formula_map)


def _restore_protected_tokens(text: str, protected_map: list[dict]) -> str:
    from retainpdf_pipeline.services.rendering.layout.protected_tokens import restore_protected_tokens

    return restore_protected_tokens(text, protected_map)


def _has_protected_token(text: str) -> bool:
    from retainpdf_pipeline.services.rendering.layout.protected_tokens import protected_token_re
