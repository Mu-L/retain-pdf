...
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_COVER_COMPLEXITY_BRIGHTNESS_SPREAD
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_COVER_MIN_SAMPLE_PIXELS
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_COVER_SAMPLE_MARGIN_PT
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_COVER_SAMPLE_SCALE
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_CLIP_SAMPLER_EXTRA_MARGIN_PT
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_FULL_PAGE_SAMPLER_MIN_RECTS
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_CLIP_SAMPLER_MAX_PAGE_AREA_RATIO
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_CLIP_SAMPLER_MIN_RECTS
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_COVER_MAX_SAMPLE_PIXELS
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_FILL_DOMINANT_BIN_SIZE
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_FILL_DOMINANT_MIN_RATIO
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_FILL_NONWHITE_MAX_CHANNEL
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_PATCH_LIGHT_BG_MEDIAN_MIN
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_PATCH_LIGHT_BG_P90_MIN
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_PATCH_TEXT_CONTAMINATION_DARK_RATIO
from retainpdf_pipeline.services.rendering.source.background.config import BACKGROUND_PATCH_TEXT_CONTAMINATION_DARK_VALUE
from retainpdf_pipeline.services.rendering.source.background.sampling import quantile
