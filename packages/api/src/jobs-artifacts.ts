...
export async function fetchJobMarkdown(jobId: string, apiPrefix?: string): Promise<any> {
...
export async function fetchJobMarkdownDocument(jobId: string, apiPrefix?: string): Promise<any> {
