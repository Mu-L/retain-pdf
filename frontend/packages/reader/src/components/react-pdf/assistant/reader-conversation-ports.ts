// Typed port/command contracts shared by the Reader conversation shell, the
// reading request hook, and the ask-runtime facade. Keeping them in a leaf
// module lets every consumer depend on the contract without importing the
// shell implementation.

import type { ConversationRecord } from "../../../external.js";
import type {
...
export const NOOP_STREAM_PORT: ReaderConversationStreamPort = {
